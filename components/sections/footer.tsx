...
export function Footer() {
  ...
  return (
    ...
    <footer 
      ...
      className="relative z-20 mt-16 text-white overflow-hidden bg-[#372847]"
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-16">
          ...
          <div className="max-w-2xl w-full">
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              ...
              <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
                ...
                <div className="w-1.5 h-1.5 bg-[#ffffff]/70 rounded-full" />

                <div className="w-1 h-1 bg-[#ffffff]/50 rounded-full" />
              ...
              <p className="text-xs sm:text-sm md:text-base font-medium text-[#ffffff] uppercase tracking-[0.25em] sm:tracking-[0.35em] mb-3 sm:mb-4">
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              ...
              <div className="mb-4 sm:mb-5 md:mb-6">
                ...
                <p
                  ...
                  className={`${windSong.className} text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-[#ffffff] leading-none drop-shadow-[0_10px_35px_rgba(55,40,71,0.65)]`}
              ...
              <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
                ...
                <p
                  ...
                  className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[12rem] font-semibold text-[#ffffff] leading-none drop-shadow-[0_18px_35px_rgba(106,35,158,0.45)]"
                ...
                <div className="h-16 sm:h-20 md:h-24 lg:h-28 w-px bg-gradient-to-b from-transparent via-[#ffffff]/60 to-transparent" />

                

                {/* Year - Elegant and refined */}

                <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-[#ffffff] leading-none tracking-[0.2em] uppercase">
            ...
            <div className="text-center">
              ...
              <div className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-[#ffffff]/85 tracking-[0.4em] uppercase mb-3 sm:mb-4 space-y-2">
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-4 gap-10 mb-12" variants={staggerChildren} initial="initial" animate="animate">
          ...
          <motion.div className="lg:col-span-2" variants={fadeInUp}>
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 flex items-center justify-center">
                  ...
                  <Image
                    ...
                    alt={`${siteConfig.debutante.nickname} Debut Monogram`}
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center gap-3 ${inter.className} text-[#ffffff]/95`}>

                  <Calendar className="w-5 h-5 text-[#ffffff]/80" />

                  <span className="text-lg">{siteConfig.wedding.date}</span>

                </div>

                <div className={`flex items-center gap-3 ${inter.className} text-[#ffffff]/90`}>

                  <MapPin className="w-5 h-5 text-[#ffffff]/70" />
            ...
            <motion.div className="bg-[#372847]/90 rounded-2xl p-6 border-2 border-white/20" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>

              <blockquote className={`${inter.className} text-white italic text-lg leading-relaxed min-h-[80px]`}>
          ...
          <motion.div className="space-y-6" variants={fadeInUp}>
            ...
            <motion.div className="bg-[#372847]/90 rounded-2xl p-6 border-2 border-white/20 hover:border-white/40 transition-all duration-300" whileHover={{ y: -5 }}>
              ...
              <div className={`space-y-3 ${inter.className} text-white/80 text-sm`}>
          ...
          <motion.div className="space-y-8" variants={fadeInUp}>
            ...
            <div>
              ...
              <h4 className={`${playfair.className} font-bold text-xl mb-6 flex items-center gap-3 text-[#ffffff]`}>

                <div className="w-2 h-8 bg-[#ffffff]/50 rounded-full" /> Follow Her Journey
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <a 
                  ...
                  className="inline-flex items-center justify-center h-11 w-11 rounded-full bg-[#ffffff]/10 border-2 border-[#ffffff]/20 hover:bg-[#ffffff]/20 hover:border-[#ffffff]/40 transition-all hover:scale-110"
                ...
                >
                  ...
                  <Music2 className="w-5 h-5 text-[#ffffff]" />
            ...
            <div>
              ...
              <h5 className={`${playfair.className} font-bold text-lg mb-4 text-[#ffffff]`}>Quick Links</h5>

              <div className="space-y-2">

                {nav.map((item) => (

                  <a key={item.href} href={item.href} className={`block text-[#ffffff]/80 hover:text-[#ffffff] transition-colors duration-200 ${inter.className} text-sm`}>
        ...
        <motion.div className="border-t border-[#ffffff]/20 pt-8" variants={fadeInUp}>

          <div className="flex flex-col md:flex-row items-center justify-between gap-6">

            <div className="text-center md:text-left">

              <p className={`text-[#ffffff]/85 ${inter.className} text-sm`}>© {year} {siteConfig.debutante.nickname}'s Debut. All rights reserved.</p>

              <p className={`text-[#ffffff]/90 ${inter.className} text-sm mt-1`}>
            ...
            <div className="text-center md:text-right space-y-1">
              ...
              <p className={`text-[#ffffff]/80 ${inter.className} text-xs`}>
                ...
                <a 
                  ...
                  className="text-[#ffffff] hover:text-[#ffffff]/80 transition-colors duration-200 underline decoration-[#ffffff]/50 hover:decoration-[#ffffff]/70"
